...
os.environ.update({
  "__VC_HANDLER_MODULE_NAME": "api.v1.admin.targets",
  "__VC_HANDLER_ENTRYPOINT": "api/v1/admin/targets.py",
  "__VC_HANDLER_ENTRYPOINT_ABS": os.path.join(_here, "api/v1/admin/targets.py"),
